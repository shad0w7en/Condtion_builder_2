...
export const mockSavedConditions: SavedCondition[] = [
  ...
  },
  {
    ...
    jsonRepresentation: '{"id":"group-2","type":"group","logicalOperator":"AND","conditions":[{"id":"cond-2","column":{"name":"created_at","displayName":"Created At","dataType":"date","table":"orders"},"operator":">","value":{"type":"value","value":"2023-01-01"}},{"id":"cond-3","column":{"name":"amount","displayName":"Amount","dataType":"number","table":"orders"},"operator":">","value":{"type":"value","value":1000}}]}',
    createdAt: new Date(),
    updatedAt: new Date()
  }
];